...
import com.rental.config.service.UserDetailsServices;
import com.rental.config.utils.UserJwtUtils;
...
public class UserAuthTokenFilter extends OncePerRequestFilter{
    ...
    public void setCorsHeaders(HttpServletRequest request, HttpServletResponse response){
        List<String> allowOrigin = Arrays.asList("http://localhost:8200");
